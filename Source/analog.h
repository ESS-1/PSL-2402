...
#define V_DEFAULT      5.0   //напряжение по умолчанию, В
#define I_DEFAULT      0.5   //ток по умолчанию, А
...
#define R47           1500 //верхний резистор делителя COM, Ом
#define R48           49.9 //нижний резистор делителя COM, Ом
#define R64         100000 //резисторы R64 = R65 диффусилителя напряжения, Ом
#define R58          10000 //резисторы R58 = R59 диффусилителя напряжения, Ом
#define R66          10000 //резисторы R66 = R67 диффусилителя тока, Ом
#define R60         100000 //резисторы R60 = R61 диффусилителя тока, Ом
#ifdef PSL2401
...
#define IP1_MAX        0.099 //максимальное значение точки 1 по току, А
#define IP2_MIN        0.100 //минимальное значение точки 2 по току, А
...
#define I_DELTA   0.010 //ном. расстояние калиб. точек от краев шкалы, А
