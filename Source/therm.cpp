...
//который подключен к соединенным выводу USART2_TX (PA2).
//Используется режим "single-wire half-duplex mode" для USART2.
//Дополнительно к этому выводу подключен подтягивающий
